...
import {send, read, setTara} from './actions';
...
class Unload extends Component {
  ...
  addLoad() {
    ...
    let tempres = parseInt(tempload, 10) + parseInt(tempweight, 10);
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.startBtn} onPress={this.sendEmpty}>
          <Text style={styles.startText}>Tøm</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
export default connect(mapStateToProps, mapDispatchToProps)(Unload);
